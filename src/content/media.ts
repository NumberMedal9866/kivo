...
export const media = {
  "hero-kiosk-front": {
    id: "hero-kiosk-front",
    src: "/images/hero-kiosk-front.webp",
    alt: {
      ru: "Киоск самообслуживания KIVO: белый корпус, чёрная рамка экрана и платёжный терминал",
      uz: "KIVO o‘z-o‘ziga xizmat kioski: oq korpus, qora ekran romkasi va to‘lov terminali",
      en: "KIVO self-service kiosk with a white body, black display bezel and payment terminal",
    },
    width: 1200,
    height: 1600,
  ...
  "kiosk-in-coffee-shop": {
    ...
    alt: {
      ru: "Киоск KIVO в интерьере кофейни",
      uz: "Qahvaxona interyeridagi KIVO kioski",
      en: "KIVO kiosk in a coffee shop interior",
    },
    width: 1600,
    height: 1200,
  ...
  "kiosk-fast-food-counter": {
    ...
    alt: {
      ru: "Киоски KIVO рядом со стойкой выдачи фастфуда",
      uz: "Fastfud peshtaxtasi yonidagi KIVO kiosklari",
      en: "KIVO kiosks next to a fast-food pickup counter",
    },
    width: 1600,
    height: 1200,
  ...
  "payment-terminal-closeup": {
    ...
    alt: {
      ru: "Крупный план платёжного терминала киоска KIVO",
      uz: "KIVO kioski to‘lov terminalining yaqin plandagi ko‘rinishi",
      en: "Close-up of the KIVO kiosk payment terminal",
    },
    width: 1200,
    height: 900,
  ...
  "kiosk-interface-menu": {
    ...
    alt: {
      ru: "Экран киоска KIVO с меню и категориями",
      uz: "Menyu va kategoriyalar ko‘rsatilgan KIVO kioski ekrani",
      en: "KIVO kiosk screen showing menu categories and items",
    },
    width: 1080,
    height: 1680,
  ...
  "kiosk-interface-language": {
    ...
    alt: {
      ru: "Выбор языка на экране киоска KIVO: узбекский, русский, английский",
      uz: "KIVO kioski ekranida til tanlash: o‘zbek, rus, ingliz",
      en: "Language selection on the KIVO kiosk screen: Uzbek, Russian, English",
    },
    width: 1080,
    height: 1680,
  ...
  "installation-team": {
    ...
    alt: {
      ru: "Специалисты KIVO устанавливают киоск в заведении",
      uz: "KIVO mutaxassislari zavedeniyada kioskni o‘rnatmoqda",
      en: "KIVO technicians installing a kiosk on site",
    },
    width: 1600,
    height: 1200,
  ...
  "hero-kiosk-detail": {
    ...
    alt: {
      ru: "Деталь корпуса киоска KIVO с монограммой",
      uz: "Monogramma tushirilgan KIVO kioski korpusining detali",
      en: "Detail of the KIVO kiosk body with the monogram",
    },
    width: 1200,
    height: 900,
